...
def setup_gemini():
    ...
    try:
        ...
        model = genai.GenerativeModel(model_name="gemini-1.5-flash", # Updated model for potential image input
...
async def summarize_article(content, image_pil=None):
    ...
    try:
        ...
        if image_pil:
            ...
            if not content: # Add prompt if only image exists
        ...
        # Check for specific API errors related to content if possible
        ...
        for entry in feed.entries:
            ...
            if image_url:
                try:
                    ...
                    image_url = None # Reset image_url if download fails
            ...
            try:
                ...
                if image_url: # Use the original image_url for the embed if download was successful initially
...
async def on_ready():
    ...
    if not setup_gemini():
        ...
        # Decide whether to continue without summarization or exit
        # await client.close(); return # Uncomment to exit if Gemini fails
            ...
            if dotenv_path:
                ...
                if new_channel_ids_str:
                    try:
                        ...
                        new_channel_ids = list(DISCORD_CHANNEL_IDS) # Keep old ones
